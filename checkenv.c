 ...
 *
 * @h: it is the head of the linked list
 * @in: input string
 ...
 * @input: Input string
 * @new_input: it is the new input string (replaced)
 * @nlen: it is the new length
 ...
 * @datash: This the data structure
 * Return: replaced string
 */
