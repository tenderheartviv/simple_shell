...
/**
 * cd_dot - will changes to the parent directory
 *
...
/**
 * cd_previous - will change to the previous directory
 *
...
/**
 * cd_shell - this will change current directory
 *
