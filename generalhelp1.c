...
/**
 * _envir - This will help information for the builtin env
...
/**
 * _setenvir - This will help information for the builtin setenv
 * Return: there is no return
 */
void _setenvir(void)
{
...
/**
 * _unsetenvir - This will help information for the builtin unsetenv
 * Return: there is no return
 */
...
/**
 * _generalhelp - Thats entry point for help information for the help builtin
 * Return: there is no return
 */
...
/**
 * _exithelp - This help information fot the builint exit
 * Return: there is no return
 */
void _exithelp(void)
{
