 ...
 * @path: type char pointing char.
 * @i: type int pointing of index.
 ...
 * @_environ: is environment variable
...
/**
 * check_error_cmd - this will verifies if user has permissions to access
 *
